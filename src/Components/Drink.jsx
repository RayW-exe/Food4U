        ...
        <>
         <div>
            <div className="bg-white/30 p-5 rounded-4xl m-4">
                <h4 className="text-black font-semibold underline text-3xl m-2">{drinksItem.name}</h4>
                <img src={drinksItem.image} alt={drinksItem.name} className="p-2 rounded-3xl w-full max-w-full h-auto m-2"/>
                <h5 className="font-semibold text-2xl">Ingredients:</h5>
                <p className="text-2xl text-center">{drinksItem.ingredients}</p>
