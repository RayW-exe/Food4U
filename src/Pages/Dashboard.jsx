    ...
    return(
        <>
         <div className="min-h-screen bg-linear-to-b from-yellow-300 via-yellow-500 to-orange-600 flex flex-col items-center justify-center">
            ...
            <div className="bg-black/40 backdrop-blur-md border-white/60 rounded-4xl shadow-2xl/35 py-24 px-8 md:py-32 md:px-14 w-full max-w-5xl m-10">
                <div className="bg-white/30 p-6 rounded-4xl">
                    ...
                    <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded m-3" onClick={onLogout}>
                        Logout
                    </button>
                </div>
            </div>
